...
PHONE_METADATA_SR = PhoneMetadata(id='SR', country_code=597, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:7[124-7]|8[1-9])\\d{5}', possible_number_pattern='\\d{7}', example_number='7412345'),
    toll_free=PhoneNumberDesc(national_number_pattern='NA', possible_number_pattern='NA'),
    premium_rate=PhoneNumberDesc(national_number_pattern='NA', possible_number_pattern='NA'),
    shared_cost=PhoneNumberDesc(national_number_pattern='NA', possible_number_pattern='NA'),
    personal_number=PhoneNumberDesc(national_number_pattern='NA', possible_number_pattern='NA'),
    voip=PhoneNumberDesc(national_number_pattern='5(?:6\\d{4}|90[0-4]\\d{3})', possible_number_pattern='\\d{6,7}', example_number='561234'),
