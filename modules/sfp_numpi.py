...
class sfp_numpi(SpiderFootPlugin):
    ...
    def query(self, qry):
        res = self.sf.fetchUrl(
            "https://numpi.com/phone-info/" + qry,
        ...
        table = re.findall(
            r'<table id="body_in_phone_info">(.+?)</table>',
            res["content"],
        ...
        name_html = re.findall(
            r'<div class="body_in_phone_id">(.+?)</div>', res["content"], re.MULTILINE | re.DOTALL
        )
