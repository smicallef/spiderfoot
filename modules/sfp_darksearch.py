...
class sfp_darksearch(SpiderFootPlugin):
    ...
    # Default options
    opts = {"fetchlinks": True, "max_pages": 20, "fullnames": True}
    ...
    def query(self, qry, page):
        ...
        res = self.sf.fetchUrl(
            "https://darksearch.io/api/search?" + urllib.parse.urlencode(params),
        ...
        while page <= pages:
            ...
            for result in data:
                ...
                if self.opts["fetchlinks"]:
                    ...
                    evt = SpiderFootEvent(
                        "DARKNET_MENTION_CONTENT", "..." + data + "...", self.__name__, event
                    )
                    self.notifyListeners(evt)
