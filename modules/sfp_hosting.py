...
class sfp_hosting(SpiderFootPlugin):
    """Hosting Providers:Footprint,Investigate,Passive:Find out if any IP addresses identified fall within known 3rd party hosting ranges, e.g. Amazon, Azure, etc."""
