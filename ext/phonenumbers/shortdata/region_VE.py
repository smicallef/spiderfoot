...
PHONE_METADATA_VE = PhoneMetadata(id='VE', country_code=None, international_prefix=None,
    ...
    emergency=PhoneNumberDesc(national_number_pattern='1(?:12|71)|911', possible_number_pattern='\\d{3}', example_number='171'),
    short_code=PhoneNumberDesc(national_number_pattern='1(?:12|71)|911', possible_number_pattern='\\d{3}', example_number='171'),
