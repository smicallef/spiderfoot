...
PHONE_METADATA_BI = PhoneMetadata(id='BI', country_code=257, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='22\\d{6}', possible_number_pattern='\\d{8}', example_number='22201234'),
    mobile=PhoneNumberDesc(national_number_pattern='(?:29|6[189]|7[124-9])\\d{6}', possible_number_pattern='\\d{8}', example_number='79561234'),
