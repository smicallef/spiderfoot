...
PHONE_METADATA_SI = PhoneMetadata(id='SI', country_code=None, international_prefix=None,
    ...
    emergency=PhoneNumberDesc(national_number_pattern='11[23]', possible_number_pattern='\\d{3,6}', example_number='112'),
    short_code=PhoneNumberDesc(national_number_pattern='11(?:[23]|6(?:000|1(?:11|23)))', possible_number_pattern='\\d{3,6}', example_number='112'),
