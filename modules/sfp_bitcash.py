...
class sfp_bitcash(SpiderFootPlugin):
    """Bitcash.cz Malicious IPs:Investigate,Passive:Blacklists:slow:Check if an IP is malicious according to Bitcash.cz Malicious IPs."""
