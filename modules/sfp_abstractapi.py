...
class sfp_abstractapi(SpiderFootPlugin):
    ...
    def watchedEvents(self):
        return ["DOMAIN_NAME", "PHONE_NUMBER", "IP_ADDRESS"]

    def producedEvents(self):
        return ["COMPANY_NAME", "SOCIAL_MEDIA", "GEOINFO", "PROVIDER_TELCO", "RAW_RIR_DATA"]
    ...
    def queryCompanyEnrichment(self, qry):
        ...
        try:
            ...
            self.sf.debug(f"Error processing JSON response from AbstractAPI Company Enrichment API endpoint: {e}")
            return
    ...
    def queryPhoneValidation(self, qry):
        ...
        try:
            ...
            self.sf.debug(f"Error processing JSON response from AbstractAPI Phone Validation API endpoint: {e}")
            return
