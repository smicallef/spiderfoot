...
class sfp_alienvaultiprep(SpiderFootPlugin):
    """AlienVault IP Reputation:Investigate,Passive:Blacklists:slow:Check if an IP or netblock is malicious according to the AlienVault IP Reputation database."""
