...
sfOptdescs = {
    ...
    '_socks6dns': "Resolve DNS through the SOCKS proxy? When TOR is used this will always be True when fetching web content. Otherwise, DNS goes to your configured DNS server.",
