...
malchecks = {
    'CryptoIOC': {
        ...
        'type': 'list',
        'checks': ['ip', 'netblock'],
        'url': 'https://cryptoioc.ch/downloads/csv',
        'regex': '.*,\"{0}\",.*'
    }
}

class sfp_cryptoioc(SpiderFootPlugin):
    """CryptoIOC.ch:Investigate,Passive:Reputation Systems::Check if an IP is participating in malicious cryptocurrency mining."""
    ...
    # Option descriptions
    optdescs = {
        'cryptoioc': "Enable Bambenek IP check?",
